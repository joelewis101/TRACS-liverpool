...
df <-
  read_csv("data/processed/micro/micro_processed20240828-1524.csv") |>
  mutate(
...
df_exp <-
  read_csv("data/processed/redcap/exposures_processed20250717-1055.csv")

df_abx <-
  read_csv("data/processed/redcap/abexp_processed20250717-1055.csv")


df_pt <-
  read_csv("data/processed/redcap/demographics_processed20250717-1055.csv")

df_adm <-
  read_csv("data/processed/redcap/admission_processed20250717-1055.csv")

df_sam <-
  read_csv("data/processed/redcap/samples_processed20250717-1055.csv")


df_cfs <-
  read_csv("data/processed/redcap/cfs_processed20250717-1055.csv") |>
    group_by(record_id) |>
    summarise(mean_cfs = mean(cfs))

df_cds <-
  read_csv("data/processed/redcap/cds_processed20250717-1055.csv") |>
